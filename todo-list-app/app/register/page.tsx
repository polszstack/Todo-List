...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#f4efe8_0%,_#faf7f2_38%,_#f3f0ea_100%)] text-stone-900">
      <main className="mx-auto grid min-h-screen w-full max-w-6xl items-center gap-10 px-6 py-16 sm:px-10 lg:grid-cols-[1.05fr_0.95fr] lg:px-12">
        <section className="max-w-xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-sm text-stone-600">
            ...
            <span className="rounded-full border border-stone-300 bg-white/80 px-4 py-2">Secure login</span>
            <span className="rounded-full border border-stone-300 bg-white/80 px-4 py-2">Personal todo space</span>
          </div>
        </section>
